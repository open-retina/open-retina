...
from openretina.models.photoreceptor_model import PhotorReceptorCoreReadout
from openretina.neuron_data_io import filter_responses, make_final_responses
from openretina.utils.h5_handling import load_h5_into_dict


@hydra.main(version_base=None, config_path="../configs", config_name="example_train_photorec_model")
def main(conf: DictConfig) -> None:
    ...
    valid_loader = DataLoader(LongCycler(dataloaders["validation"], shuffle=False), **conf.dataloader)
    ...
    model = PhotorReceptorCoreReadout(
