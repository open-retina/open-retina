...
- **[Maheswaranathan et al. 2023](data_io/maheswaranathan_2023.md)** — Tiger salamander retinal ganglion cell responses to natural scenes. From [Interpreting the retinal neural code for natural scenes: From computations to neurons](https://doi.org/10.1016/j.neuron.2023.06.007) (Neuron).
